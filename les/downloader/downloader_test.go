...
func TestCanonicalSynchronisation66Fast(t *testing.T)  { testCanonSync(t, G.ETH66, FastSync) }
...
func TestThrottling66Fast(t *testing.T) { testThrottling(t, G.ETH66, FastSync) }
...
func TestForkedSync66Fast(t *testing.T)  { testForkedSync(t, G.ETH66, FastSync) }
...
func TestHeavyForkedSync66Fast(t *testing.T)  { testHeavyForkedSync(t, G.ETH66, FastSync) }
...
func TestBoundedForkedSync66Fast(t *testing.T)  { testBoundedForkedSync(t, G.ETH66, FastSync) }
...
func TestBoundedHeavyForkedSync66Fast(t *testing.T) {
	testBoundedHeavyForkedSync(t, G.ETH66, FastSync)
}
...
func TestCancel66Fast(t *testing.T)  { testCancel(t, G.ETH66, FastSync) }
...
func TestMultiSynchronisation66Fast(t *testing.T)  { testMultiSynchronisation(t, G.ETH66, FastSync) }
...
func TestMultiProtoSynchronisation66Fast(t *testing.T)  { testMultiProtoSync(t, G.ETH66, FastSync) }
...
func testMultiProtoSync(t *testing.T, protocol uint, mode SyncMode) {
	...
	tester.newPeer("peer 66", G.ETH66, chain)
	//tester.newPeer("peer 65", G.ETH67, chain)
...
func TestEmptyShortCircuit66Fast(t *testing.T)  { testEmptyShortCircuit(t, G.ETH66, FastSync) }
...
func TestMissingHeaderAttack66Fast(t *testing.T)  { testMissingHeaderAttack(t, G.ETH66, FastSync) }
...
func TestShiftedHeaderAttack66Fast(t *testing.T)  { testShiftedHeaderAttack(t, G.ETH66, FastSync) }
...
func TestInvalidHeaderRollback66Fast(t *testing.T) { testInvalidHeaderRollback(t, G.ETH66, FastSync) }
...
func TestHighTDStarvationAttack66Fast(t *testing.T) {
	testHighTDStarvationAttack(t, G.ETH66, FastSync)
}
...
func TestSyncProgress66Fast(t *testing.T)  { testSyncProgress(t, G.ETH66, FastSync) }
...
func TestForkedSyncProgress66Fast(t *testing.T)  { testForkedSyncProgress(t, G.ETH66, FastSync) }
...
func TestFailedSyncProgress66Fast(t *testing.T)  { testFailedSyncProgress(t, G.ETH66, FastSync) }
...
func TestFakedSyncProgress66Fast(t *testing.T)  { testFakedSyncProgress(t, G.ETH66, FastSync) }
...
func TestDeliverHeadersHang66Full(t *testing.T)  { testDeliverHeadersHang(t, G.ETH66, FullSync) }
func TestDeliverHeadersHang66Fast(t *testing.T)  { testDeliverHeadersHang(t, G.ETH66, FastSync) }
func TestDeliverHeadersHang66Light(t *testing.T) { testDeliverHeadersHang(t, G.ETH66, LightSync) }
...
func TestCheckpointEnforcement66Fast(t *testing.T) { testCheckpointEnforcement(t, G.ETH66, FastSync) }
