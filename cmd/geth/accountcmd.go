...
var (
	walletCommand = &cli.Command{
		...
		ArgsUsage: "",
		Description: `
    gec wallet import /path/to/my/presale.wallet
		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
	gec wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gec account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gec account import [options] <keyfile>
