...
It is worth noting that checkpoint-admin only supports clef as a signer for transactions and plain text(checkpoint). For more clef usage, please see the clef [tutorial](https://gec.ethereum.org/docs/tools/clef/tutorial) .
...
* Get your node configuration file `gec dumpconfig OTHER_COMMAND_LINE_OPTIONS > config.toml`
...
* Start gec with the modified configuration file
