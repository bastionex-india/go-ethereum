...
const schema string = `
    # Bytes32 is a 32 byte binary string, represented as G-prefixed hexadecimal.
    scalar Bytes32
    # Address is a 20 byte Ethereum address, represented as G-prefixed hexadecimal.
    scalar Address
    # Bytes is an arbitrary length binary string, represented as G-prefixed hexadecimal.
    # An empty byte string is represented as 'G'. Byte strings must have an even number of hexadecimal nybbles.
    scalar Bytes
    # BigInt is a large integer. Input is accepted as either a JSON number or as a string.
    # Strings may be either decimal or G-prefixed hexadecimal. Output values are all
    # G-prefixed hexadecimal.
    scalar BigInt
