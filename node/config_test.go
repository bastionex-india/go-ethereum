...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gec.ipc", false, filepath.Join(os.TempDir(), "gec.ipc")},
		{"data", "gec.ipc", false, "data/gec.ipc"},
		{"data", "./gec.ipc", false, "./gec.ipc"},
		{"data", "/gec.ipc", false, "/gec.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gec.ipc", true, `\\.\pipe\gec.ipc`},
		{"data", "gec.ipc", true, `\\.\pipe\gec.ipc`},
		{"data", `\\.\pipe\gec.ipc`, true, `\\.\pipe\gec.ipc`},
	}
