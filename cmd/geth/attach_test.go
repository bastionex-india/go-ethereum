...
// TestAttachWithHeaders tests that 'gec attach' with custom headers works, i.e
...
// TestAttachWithHeaders tests that 'gec db --remotedb' with custom headers works, i.e
// that custom headers are forwarded to the target.
