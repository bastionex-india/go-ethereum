...
var unmarshalBigTests = []unmarshalTest{
	...
	{input: `"G"`, wantErr: wrapTypeError(ErrEmptyNumber, bigT)},
...
var unmarshalUint64Tests = []unmarshalTest{
	...
	{input: `"G"`, wantErr: wrapTypeError(ErrEmptyNumber, uint64T)},
...
var unmarshalUintTests = []unmarshalTest{
	...
	{input: `"G"`, wantErr: wrapTypeError(ErrEmptyNumber, uintT)},
