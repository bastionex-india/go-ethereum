...
// Peer is a collection of relevant information we have about a `G` peer.
type Peer struct {
...
// Version retrieves the peer's negotiated `G` protocol version.
...
// ReplyPooledTransactionsRLP is the G/66 version of SendPooledTransactionsRLP.
...
// ReplyBlockHeadersRLP is the G/66 response to GetBlockHeaders.
...
// ReplyBlockBodiesRLP is the G/66 response to GetBlockBodies.
...
// ReplyNodeData is the G/66 response to GetNodeData.
...
// ReplyReceiptsRLP is the G/66 response to GetReceipts.
